...
constexpr int kFeatureSize = 40;       // num_filters
constexpr int kFeatureCount = 49;      // from input shape
constexpr int kFeatureElementCount = (kFeatureSize * kFeatureCount);
constexpr int kFeatureStrideMs = 20;   // window_step_ms
constexpr int kFeatureDurationMs = 30; // window_size_ms
